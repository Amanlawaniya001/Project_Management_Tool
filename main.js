document.addEventListener("DOMContentLoaded", function () {
    ...
    const tasks = [
        { taskName: 'Task 1', assignedTo: 'Abhishek Kumar', dueDate: '2023-11-01', description: 'Description for Task 1' },
        { taskName: 'Task 2', assignedTo: 'Jiya', dueDate: '2023-11-10', description: 'Description for Task 2' },
       { taskName: 'Task 3', assignedTo: 'John', dueDate: '2023-10-22', description: 'Description for Task 3' },
    // Add more tasks here
